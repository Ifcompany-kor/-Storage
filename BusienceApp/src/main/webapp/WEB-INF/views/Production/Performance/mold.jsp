...
<script>
	function searchBtn() {
		...
		$.ajax({
			method : "GET",
			url : "${contextPath}/PerformanceRest/PerformanceMold?data="+ encodeURI(JSON.stringify(data)) + "",
	...
	function MOLD_INFO_NO_SELECT() {
		...
		localStorage.setItem('MOLD_INFO_NAME', document.getElementById("MOLD_INFO_NAME").value);
		var url = "${contextPath}/mold_popup";
	...
	function tableSetting(datas) {
		table = new Tabulator("#example-table", { 
	    	...
	    	height:"75%",
	     	...
	     	{title:"금형No", field:"production_MOLD_INFO_CODE", headerHozAlign:"center",hozAlign:"right"},
						...
						<table
							...
							<tr>
								<td colspan="25"><font style="margin-left: 5px;"
									size="5px;" face="Noto Sans KR">생산 실적 관리 (금형별)</font></td>
							</tr>
							<tr>
								<td colspan="6"></td>
							...
							<tr>
								...
								<td colspan="3" align="left"><input
									id="MOLD_INFO_NO" type="text" style="width: 90%;"
									autocomplete="off" disabled="disabled"></td>
								<td colspan="1" align="right">금형명&nbsp;</td>
								<td colspan="3" align="left"><input
									id="MOLD_INFO_NAME" type="text" style="width: 90%;"
									autocomplete="off"
