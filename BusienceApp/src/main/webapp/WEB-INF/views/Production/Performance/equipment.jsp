...
<script>
	function searchBtn() {
		...
		$.ajax({
			method : "GET",
			url : "${contextPath}/PerformanceRest/PerformanceEquipment?data="
	...
	function EQUIPMENT_ITEM_CODE_SELECT() {
		...
		localStorage.setItem('EQUIPMENT_INFO_NAME', document.getElementById("EQUIPMENT_INFO_NAME").value);
						...
						<table
							...
							<tr>
								<td colspan="25"><font style="margin-left: 5px;"
									size="5px;" face="Noto Sans KR">생산 실적 관리 (설비별)</font></td>
							</tr>
							<tr>
								<td colspan="6"></td>
							...
							<tr>
								...
								<td colspan="3" align="left"><input
									id="EQUIPMENT_INFO_CODE" type="text" style="width: 90%;"
									autocomplete="off" disabled="disabled"></td>
								<td colspan="1" align="right">설비명&nbsp;</td>
								<td colspan="3" align="left"><input
									id="EQUIPMENT_INFO_NAME" type="text" style="width: 90%;"
									autocomplete="off"
