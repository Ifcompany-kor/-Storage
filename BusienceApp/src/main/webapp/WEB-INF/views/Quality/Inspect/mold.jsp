...
<script>
   function searchBtn() {
	  ...
	  if (document.getElementById('MOLD_INFO_NAME').value == "") {
	    if(document.getElementById('MOLD_INFO_NO').value != "")
	    	  document.getElementById('MOLD_INFO_NO').value = MOLD_INFO_NO
	  }
      ...
      data = {
         ...
         MOLD_INFO_NAME : document.getElementById('MOLD_INFO_NAME').value,
      ...
      $.ajax({
         method : "GET",
         url : "${contextPath}/InspectionRest/InspectionMold?data="
   ...
   function MOLD_INFO_NO_SELECT() {
      // 웹 브라우저내에 PRODUCTION_EQUIPMENT_INFO_NAME변수를 생성해서 PRODUCT_ITEM_NAME이라는 ID값의 Input태그에 담긴 값을 임시적으로 저장한다.
      localStorage.setItem('MOLD_INFO_NAME', document
            .getElementById("MOLD_INFO_NAME").value);
      var url = "${contextPath}/MoldQuality_ItemCode";
      var name = "MOLD_INFO_NO";
                  ...
                  <table
                     ...
                     <tr>
                        <td colspan="25"><font style="margin-left: 5px;"
                           size="5px;" face="Noto Sans KR">검사 이력 관리 (금형별)</font></td>
                     </tr>
                     <tr>
                        <td colspan="6"></td>
                     ...
                     <tr>
                        <td colspan="3"></td>
                        <td colspan="2" align="right">금형No&nbsp;</td>
                        <td colspan="3" align="left"><input id="MOLD_INFO_NO"
                           type="text" style="width: 90%;" autocomplete="off"
                           disabled="disabled"></td>
                        <td colspan="1" align="right">금형명&nbsp;</td>
                        <td colspan="3" align="left"><input id="MOLD_INFO_NAME"
                           type="text" style="width: 90%;" autocomplete="off"
                           onkeypress="javascript:if(event.keyCode==13) {MOLD_INFO_NO_SELECT()}">
                        </td>
                     </tr>
                     <tr>
                        <td colspan="3"></td>
                        <td colspan="2" align="right">불량코드&nbsp;</td>
                        <td colspan="3" align="left"><input id="PRODUCTION_DEFECT_CODE"
                           type="text" style="width: 90%;" autocomplete="off"
                           disabled="disabled"></td>
                        <td colspan="1" align="right">불량명&nbsp;</td>
                        <td colspan="3" align="left"><input id="PRODUCTION_DEFECT_NAME"
                           type="text" style="width: 90%;" autocomplete="off"
