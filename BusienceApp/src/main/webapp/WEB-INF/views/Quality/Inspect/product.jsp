...
<script>
	function searchBtn() {
		...
		$.ajax({
			method : "GET",
			url : "${contextPath}/InspectionRest/InspectionProduct?data="
	...
	function tableSetting(datas) {
			...
			{title : "순번", field : "production_INFO_NUM", headerHozAlign : "center", hozAlign:"left", width : 85}, 
						...
						<table
							...
							<tr>
								<td colspan="25"><font style="margin-left: 5px;"
									size="5px;" face="Noto Sans KR">검사 이력 관리 (제품별)</font></td>
							</tr>
							<tr>
								<td colspan="6"></td>
