...
<script>
	...
	function search() {
		$.ajax({
			method : "GET",
			url : "${contextPath}/popup?MOLD_INFO_NO="
			...
			success : function(data) {
				...
				table = new Tabulator("#example-table", { 
                    ...
                    rowClick:function(e, row){
                       console.log(row.getData().production_MOLD_INFO_CODE);
                       document.getElementById("MOLD_INFO_NAME").value = row.getData().production_MOLD_INFO_NAME;
                       document.getElementById("MOLD_INFO_NO").value = row.getData().production_MOLD_INFO_CODE;
                       //row.getData()
                       //transfer();
                    },
                    rowDblClick:function(e, row){
                       ...
                       window.opener.document.getElementById("MOLD_INFO_NO").value = row.getData().production_MOLD_INFO_CODE;
                       window.opener.document.getElementById("MOLD_INFO_NAME").value = row.getData().production_MOLD_INFO_NAME;
                       window.close();
                    },
                   height:"100%",
                    data:datas, 
                   ...
                   {title:"금형No", field:"production_MOLD_INFO_CODE", width:100,headerHozAlign:"center"},
                   {title:"금형명", field:"production_MOLD_INFO_NAME", width:200,headerHozAlign:"center"}
                    ],
                });
			}
		});
