...
public class RIGHTS_MGMT_TBL {
	String RIGHTS_USER_TYPE,
    RIGHTS_PROGRAM_CODE,
    RIGHTS_MGMT_USE_STATUS;
	
	String NEW_TBL_CODE,CHILD_TBL_NUM,CHILD_TBL_TYPE,CHILD_TBL_RMARK;

	public RIGHTS_MGMT_TBL(String rIGHTS_USER_TYPE, String rIGHTS_PROGRAM_CODE, String rIGHTS_MGMT_USE_STATUS,
			String nEW_TBL_CODE, String cHILD_TBL_NUM, String cHILD_TBL_TYPE, String cHILD_TBL_RMARK) {
		super();
	...
	public String toString() {
		return "RIGHTS_MGMT_TBL [RIGHTS_USER_TYPE=" + RIGHTS_USER_TYPE + ", RIGHTS_PROGRAM_CODE=" + RIGHTS_PROGRAM_CODE
				+ ", RIGHTS_MGMT_USE_STATUS=" + RIGHTS_MGMT_USE_STATUS + ", NEW_TBL_CODE=" + NEW_TBL_CODE
				+ ", CHILD_TBL_NUM=" + CHILD_TBL_NUM + ", CHILD_TBL_TYPE=" + CHILD_TBL_TYPE + ", CHILD_TBL_RMARK="
				+ CHILD_TBL_RMARK + "]";
	}
}
